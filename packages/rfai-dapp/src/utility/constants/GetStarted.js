...
export const GetStartedCategoriesData = [
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          `<p>Use your <a href="https://metamask.io/" target="_blank">Metamask </a>wallet to user your AGIX tokens</p>`,
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    content: [
      {
        type: "description",
        value: `<p>Every Backer for a request will be granted the opportunity to vote for on any of the avalible solutions.  A Backer’s vote will determine where their AGIX tokens will be distributed to.  If they vote for more than one solution, their AGIX tokens will be divided among the solutions they voted for.</p><p> There is a limited time period that Backers can vote.  This time limit will be specified by each request.   If the Backer does not participate in the voting process, the SingularityNET foundation vote will be considered and the reward AGIX tokens will be distributed accordingly.</p>`,
      },
    ],
  },
  {
