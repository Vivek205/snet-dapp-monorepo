      ...
      onEnd: response => {
        ...
        this.setState({
          ...
          response: {
            ...
            class_ids: message.getClassIds(),
            confidences: message.getConfidences(),
    ...
    return (
      <div style={{ background: "#F8F8F8", padding: "24px" }}>
        ...
        <div style={{ padding: "10px 10px 0 10px", fontSize: "14px", color: "#9b9b9b" }}>
          ...
          <div style={{ padding: "10px 0", borderBottom: "1px solid #eee" }}>
            Time: <span style={{ color: "#212121" }}>{delta_time}</span>
          </div>
          <div style={{ padding: "10px 0", borderBottom: "1px solid #eee" }}>
            Boxes: <span style={{ color: "#212121" }}>{boxes}</span>
          </div>
          <div style={{ padding: "10px 0", borderBottom: "1px solid #eee" }}>
            Classes: <span style={{ color: "#212121" }}>{class_ids}</span>
          </div>
          <div style={{ padding: "10px 0", borderBottom: "1px solid #eee" }}>
            Confidences: <span style={{ color: "#212121" }}>{confidences}</span>
          </div>
