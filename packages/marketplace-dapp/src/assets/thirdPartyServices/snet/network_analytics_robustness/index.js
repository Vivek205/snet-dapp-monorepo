...
export default class NetworkAnalysisRobustness extends React.Component {
        ...
        onEnd: response => {
          ...
          this.setState({
            response: {
              ...
              nodes_output: message.getNodesOutputList(),
              edges_output: message.getEdgesOutputList(),
            },
          });
        },
      };
        ...
        onEnd: response => {
          ...
          this.setState({
            response: {
              status: "success",
              message: message.getMessage(),
              nodes_between_centrality: message.getNodeBetweennessCentrality(),
              edges_between_centrality: message.getEdgeBetweennessCentrality(),
            },
          });
        },
      };
  ...
  renderForm() {
    const serviceNameOptions = [
      "Select a method",
      ...this.props.serviceClient.getMethodNames(NetworkAnalyticsRobustness),
    ];
