...
const SNETStatusBanner = ({ classes, title, img, description, actions, pending, rejected }) => {
  return (
    <Grid container spacing={24} className={classes.statusBannerContainer}>
      ...
      <Grid item xs={12} sm={8} md={8} lg={8} className={classes.statusBannerContent}>
        <Typography variant="h6" className={pending ? classes.pendingtitle : rejected ? classes.rejectedtitle : null}>
          {title}
        </Typography>
