  ...
  return (
    <div className={classes.inviteContainer}>
      ...
      <Typography variant="subtitle2">
        People you invited and that have accepted will be published to your company’s blockchain. Any invitations that
        are currently pending can be added to blockchain by you (the owner) afterwards.
      </Typography>
      <Grid container className={classes.table}>
        <Grid item xs={12} sm={12} md={12} lg={12} className={classes.tableColumn}>
          <Grid item xs={12} sm={4} md={4} lg={4}>
            <Typography className={classes.th}>email</Typography>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={4}>
            <Typography className={classes.th}>name</Typography>
          </Grid>
          <Grid item xs={12} sm={4} md={4} lg={4}>
