    ...
    <Grid container className={classes.enrollMainContainer}>
      ...
      <Grid item xs={12} sm={12} md={12} lg={12}>
        ...
        <Typography variant="body2">
         If you are an individual or sole proprietor/single person business, get started by signing in with SingularityNET account.  You’ll need to provide basic personal information, including your legal name and address.
        </Typography>
      ...
      <Grid item xs={12} sm={12} md={12} lg={12} className={classes.companyOrgReg}>
        ...
        <Typography variant="body2">
         If you’re enrolling your company organization, you’ll need to sign in with your SingularityNET account, as well as the following to get started:
        </Typography>
        <div>
          <Typography variant="subtitle1" display="inline">D-U-N-S Number:</Typography>
          <Typography variant="body2" display="inline">
            Your organization must have a D-U-N-S Number so that we can verify your organization’s identity and legal entity status. These unique nine-digit numbers are assigned by Dun & Bradstreet and are widely used as standard business identifiers. You can check to see if your organization already has a D-U-N-S Number and request one if necessary. They are free in most jurisdictions. <a href="#">Learn more,</a>
          </Typography>
        </div>
        <div>
          <Typography variant="subtitle1" display="inline">Legal Binding Authority:</Typography>
          <Typography variant="body2" display="inline">
            As the person enrolling your organization in the SingularityNET Publisher, you must have the legal authority to bind your organization to legal agreements. You must be the organization’s owner/founder, executive team member, senior project lead, or have legal authority granted to you by a senior employee.
          </Typography>
        </div>
      </Grid>
